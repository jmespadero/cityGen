...
def createHouseTemplates():
    return [[["Door1", 0.50, 0.00, 1.50],
             ["Window4", 0.33, 0.75, 1.50],
             ["Window4", 0.66, 0.75, 1.50]],
            [["Door1", 0.65, 0.00, 1.50],
             ["Window2", 0.30, 0.30, 1.50],
             ["Window1", 0.30, 0.75, 1.50],
             ["Window1", 0.65, 0.75, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ["Window2", 0.30, 0.60, 1.50],
             ["Window2", 0.30, 0.80, 1.50],
             ["Window2", 0.70, 0.60, 1.50],
             ["Window2", 0.70, 0.80, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ["Window3", 0.25, 0.65, 1.50],
             ["Window3", 0.50, 0.65, 1.50],
             ["Window3", 0.75, 0.65, 1.50]],
            [["Door1", 0.50, 0.00, 1.50],
             ["Door1Boards", 0.50, 0.00, 1.50],
             ["Balcony1", 0.50, 0.60, 1.50],
             ["Window4", 0.50, 0.50, 1.50],
             ["Door1", 0.45, 0.61, 1.00],
             ["Door1Boards", 0.45, 0.61, 1.00]],

            [["Door4", 0.25, 0.00, 1.50],
             ["Window3", 0.65, 0.30, 1.50],
             ["Window3", 0.85, 0.30, 1.50],
             ["Window1", 0.20, 0.75, 1.50],
             ["Window1", 0.40, 0.75, 1.50],
             ["Window1", 0.60, 0.75, 1.50],
             ["Window1", 0.80, 0.75, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ["Window3", 0.10, 0.30, 1.50],
             ["Window3", 0.25, 0.30, 1.50],
             ["Window3", 0.75, 0.30, 1.50],
             ["Window3", 0.90, 0.30, 1.50],
             ["Window5", 0.175, 0.70, 1.50],
             ["Window5", 0.825, 0.70, 1.50]],
            [["Door1", 0.25, 0.00, 1.50],
             ["Window2", 0.55, 0.25, 1.50],
             ["Window2", 0.85, 0.25, 1.50],
             ["Window2", 0.20, 0.63, 1.50],
             ["Window2", 0.50, 0.63, 1.50],
             ["Window3", 0.20, 0.87, 1.50],
             ["Window3", 0.80, 0.87, 1.50]],
            [["Door1", 0.20, 0.00, 1.50],
             ["Door1", 0.80, 0.00, 1.50],
             ["Window2", 0.50, 0.30, 1.50],
             ["Window1", 0.20, 0.80, 1.50],
             ["Window1", 0.40, 0.80, 1.50],
             ["Window1", 0.60, 0.80, 1.50],
             ["Window1", 0.80, 0.80, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ["Balcony2", 0.50, 0.60, 1.50],
             ["Door1", 0.55, 0.61, 1.00],
             ["Window2", 0.15, 0.30, 1.50],
             ["Window2", 0.85, 0.30, 1.50],
             ["Window3", 0.15, 0.55, 1.50],
             ["Window3", 0.15, 0.80, 1.50],
             ["Window3", 0.85, 0.55, 1.50],
             ["Window3", 0.85, 0.80, 1.50]],

            [["Door4", 0.25, 0.00, 1.50],
             ["Window3", 0.15, 0.80, 1.50],
             ["Window3", 0.25, 0.80, 1.50],
             ["Window3", 0.35, 0.80, 1.50],
             ["Door1", 0.80, 0.00, 1.50],
             ["Window2", 0.60, 0.30, 1.50],
             ["Window1", 0.60, 0.70, 1.50],
             ["Window4", 0.80, 0.65, 1.50]],
            [["Door4", 0.25, 0.00, 1.50],
             ["Balcony2", 0.75, 0.50, 1.50],
             ["Door1", 0.75, 0.51, 1.00],
             ["Window2", 0.75, 0.25, 1.50],
             ["Window4", 0.25, 0.50, 1.50],
             ["Window2", 0.15, 0.70, 1.50],
             ["Window2", 0.35, 0.70, 1.50]],
            [["Door4", 0.80, 0.00, 1.50],
             ["Balcony3", 0.30, 0.60, 1.50],
             ["Door1", 0.20, 0.61, 1.00],
             ["Door1", 0.20, 0.00, 1.50],
             ["Window2", 0.40, 0.75, 1.00],
             ["Window2", 0.70, 0.55, 1.50],
             ["Window1", 0.70, 0.85, 1.50],
             ["Window2", 0.90, 0.55, 1.50],
             ["Window1", 0.90, 0.85, 1.50]]]
