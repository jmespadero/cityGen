...
def createHouseTemplates():
    return [[["Door1", 0.50, 0.00, 1.50],
            ...
            [["Door1", 0.65, 0.00, 1.50],
             ["Window1", 0.30, 0.30, 1.50],
             ["Window2", 0.30, 0.75, 1.50],
             ["Window2", 0.65, 0.75, 1.50]],
            ...
            [["Door4", 0.25, 0.00, 1.50],
             ["Window1", 0.65, 0.30, 1.50],
             ["Window1", 0.85, 0.30, 1.50],
             ["Window3", 0.20, 0.75, 1.50],
             ["Window3", 0.40, 0.75, 1.50],
             ["Window3", 0.60, 0.75, 1.50],
             ["Window3", 0.80, 0.75, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ...
             ["WindowsDoubleLow1Boards", 0.42, 0.63, 1.50],
             ["WindowsDoubleLow1Boards", 0.58, 0.63, 1.50]],
            [["Door1", 0.25, 0.00, 1.50],
             ["Window5", 0.55, 0.25, 1.50],
             ["Window5", 0.85, 0.25, 1.50],
             ["Window2", 0.20, 0.63, 1.50],
             ["Window2", 0.50, 0.63, 1.50],
             ["Window2", 0.20, 0.87, 1.50],
             ["Window2", 0.80, 0.87, 1.50]],
            [["Door1", 0.20, 0.00, 1.50],
             ["Door1", 0.80, 0.00, 1.50],
             ["Window6", 0.20, 0.50, 1.50],
             ["Window6", 0.80, 0.50, 1.50],
             ["Window1", 0.50, 0.30, 1.50],
             ["Window2", 0.20, 0.80, 1.50],
             ["Window2", 0.40, 0.80, 1.50],
             ["Window2", 0.60, 0.80, 1.50],
             ["Window2", 0.80, 0.80, 1.50]],
            [["Door4", 0.50, 0.00, 1.50],
             ["Balcony2", 0.50, 0.60, 1.50],
             ["Door1", 0.55, 0.61, 1.00],
             ["Window1", 0.15, 0.30, 1.50],
             ["Window1", 0.85, 0.30, 1.50],
            ...
            [["Door4", 0.25, 0.00, 1.50],
             ["Door1", 0.80, 0.00, 1.50],
             ["Window1", 0.60, 0.30, 1.50],
             ["Window2", 0.60, 0.70, 1.50],
             ["Window4", 0.80, 0.65, 1.50]],
            [["Door4", 0.25, 0.00, 1.50],
             ["Balcony2", 0.75, 0.50, 1.50],
             ["Door1", 0.75, 0.51, 1.00],
             ["Window1", 0.75, 0.25, 1.50],
            ...
            [["Door4", 0.80, 0.00, 1.50],
             ...
             ["Window1", 0.70, 0.55, 1.50],
             ["Window2", 0.70, 0.85, 1.50],
             ["Window1", 0.90, 0.55, 1.50],
             ["Window2", 0.90, 0.85, 1.50]]]
